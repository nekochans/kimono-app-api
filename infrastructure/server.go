...
func NewServer(logger *zap.Logger, region, userPoolId, userPoolClientId string) *HTTPServer {
	return &HTTPServer{
...
func (s *HTTPServer) Middleware() {
	...
	s.router.Use(httputil.Auth(s.region, s.userPoolId, s.userPoolClientId))
}
